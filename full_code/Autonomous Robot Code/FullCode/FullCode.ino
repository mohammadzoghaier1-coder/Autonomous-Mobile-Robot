  ...
  // ==================== BlueTooth Write Functions =================
    ...
    void WriteLeftEncoderBlueTooth()
    {
    ...
    void WriteRightEncoderBlueTooth()
    {
      SerialBT.print("Right Encoder: ");
      SerialBT.print(rightEncoderCount);
    }
    ...
    void CorrectOffset()
    {
      ...
      if (leftWallDistance < 6)
      {
        if (leftWallDistance < 4)
        {
          ...
          {
            MotorBackward(95, LEFT);
            MotorBackward(95, RIGHT);
          }
